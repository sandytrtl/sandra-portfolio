...
const projects = [
  ...
  },
  {
    number: '03',
    title: 'Sandysnaps',
    subtitle: 'A browser-based photobooth app — snap, strip, and share moments straight from your webcam.',
    tags: ['React 18', 'Vite', 'Tailwind CSS', 'WebRTC', 'MediaDevices API', 'HTML5 Canvas'],
    role: 'UI/UX Designer · Frontend Developer',
    year: '2026',
    color: '#9C775C',
    bgAccent: 'rgba(156,119,92,0.05)',
    images: ['/images/S1.svg', '/images/S2.svg', '/images/S3.svg'],
    github: 'https://github.com/sandytrtl/SANDYSNAPS',
    liveUrl: 'https://sandysnaps.netlify.app/',
    clickable: true,
  },
  {
    number: '04',
    title: 'Gentle Monster',
    subtitle: 'A Gentle Monster-inspired brand landing page with bold editorial design and immersive visuals.',
    tags: ['React 18', 'Vite 5', 'Tailwind CSS 3.4', 'lucide-react', 'Google Fonts'],
    role: 'UI/UX Designer · Frontend Developer',
    year: '2026',
    color: '#9C775C',
    bgAccent: 'rgba(156,119,92,0.05)',
    images: ['/images/G1.svg', '/images/G2.svg', '/images/G3.svg'],
    github: 'https://github.com/sandytrtl/Gentle-Monster',
    liveUrl: 'https://gentlemonsterz.netlify.app/',
    clickable: true,
  },
];
